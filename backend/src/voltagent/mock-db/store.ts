...
function seedData(): void {
  ...
  const seedListings: Listing[] = [
    ...
    // Without these, buy_produce searches in Littoral/Centre only returned 1–2 items,
    // making the search experience feel broken.
    {
      id: 'lst_014',
      type: 'sell',
      status: 'active',
