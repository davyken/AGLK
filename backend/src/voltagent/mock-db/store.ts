...
export interface PipelineConversationState {
  ...
  userName?: string;   // persisted once the user provides their name
  userRegion?: string; // persisted once the user's region is known
}
...
function seedData(): void {
  ...
  // ── Farmer profiles ──────────────────────────────────────────────────────────
  // One profile per real phone number. Paul Biya Nde (formerly +237691000005)
  // has been merged into +237652499248; his buy listing (lst_004) now carries
  // that phone so the farmer Map has no collisions.
  const seedFarmers: FarmerProfile[] = [
    ...
    },
    {
      ...
      name: 'Mary Tabi',
      region: 'Northwest',
      cropsGrown: ['tomatoes', 'njama njama', 'eru', 'beans'],
      role: 'farmer',
      language: 'pidgin',
    ...
    },
    {
      ...
      region: 'Centre',
      cropsGrown: ['plantain', 'palm oil', 'cassava', 'beans'],
      role: 'both',
      language: 'fr',
    ...
    },
    {
      ...
      name: 'Agnes Fonkam',
      region: 'Littoral',
      cropsGrown: ['egusi', 'mbongo', 'okok', 'beans'],
      role: 'both',
      language: 'fr',
  ...
  // ── Listings ─────────────────────────────────────────────────────────────────
  // Phone number mapping applied consistently:
  //   +237671000001 / +237681000001 / +237671000014 / +237671000017 / +237671000020 → +237693230485 (Jean-Pierre)
  //   +237691000002 / +237691000006 / +237691000008 / +237691000016 / +237691000019 → +237696736947 (Mary Tabi)
  //   +237681000003 / +237661000013 / +237681000015 / +237681000018               → +237672260392 (Emmanuel)
  //   +237671000004 / +237691000005 / +237661000009–013                           → +237652499248 (Agnes)
  const seedListings: Listing[] = [
    ...
    // ── Extra listings for Douala & Yaoundé (major market hubs) ─────────────────
    {
      id: 'lst_014',
      type: 'sell',
      status: 'active',
      ...
      region: 'Littoral',
      userPhone: '+237693230485',
      userName: 'Christophe Fotso',
      freshness: 'dry stock, ready to deliver',
    ...
    },
    {
      ...
      region: 'Northwest',
      userPhone: '+237693230485',
      userName: 'Titus Wainkem',
      createdAt: now.toISOString(),
      expiresAt: in30Days.toISOString(),
    },
    // ── Beans listings (new crop) ────────────────────────────────────────────────
    {
      id: 'lst_021',
      type: 'sell',
      status: 'active',
      crop: 'beans',
      cropNormalized: 'beans',
      quantity: 100,
      unit: 'kg',
      priceXaf: 350,
      location: 'Yaoundé',
  ...
  const seedPrices: PriceRecord[] = [
    ...
    // Prices for the new Douala/Yaoundé/Bamenda listings (lst_014–lst_020)
    { id: 'p16', crop: 'maïs',       cropNormalized: 'maize',       region: 'Littoral',  priceXaf: 260,  unit: 'kg',     recordedAt: new Date(now.getTime() - 1 * 86400000).toISOString(), source: 'listing' },
    { id: 'p17', crop: 'cassava',    cropNormalized: 'cassava',     region: 'Littoral',  priceXaf: 190,  unit: 'kg',     recordedAt: new Date(now.getTime() - 2 * 86400000).toISOString(), source: 'listing' },
    { id: 'p18', crop: 'plantain',   cropNormalized: 'plantain',    region: 'Littoral',  priceXaf: 1400, unit: 'bunch',  recordedAt: new Date(now.getTime() - 1 * 86400000).toISOString(), source: 'listing' },
    { id: 'p19', crop: 'tomates',    cropNormalized: 'tomatoes',    region: 'Centre',    priceXaf: 750,  unit: 'kg',     recordedAt: new Date(now.getTime() - 1 * 86400000).toISOString(), source: 'listing' },
    { id: 'p20', crop: 'cocoyam',    cropNormalized: 'cocoyam',     region: 'Centre',    priceXaf: 300,  unit: 'kg',     recordedAt: now.toISOString(),                                     source: 'listing' },
    { id: 'p21', crop: 'eru',        cropNormalized: 'eru',         region: 'Northwest', priceXaf: 2000, unit: 'kg',     recordedAt: now.toISOString(),                                     source: 'listing' },
    { id: 'p22', crop: 'maïs',       cropNormalized: 'maize',       region: 'Northwest', priceXaf: 240,  unit: 'kg',     recordedAt: now.toISOString(),                                     source: 'listing' },
    // Beans prices (lst_021–lst_023)
    { id: 'p23', crop: 'beans',      cropNormalized: 'beans',       region: 'Centre',    priceXaf: 350,  unit: 'kg',     recordedAt: new Date(now.getTime() - 1 * 86400000).toISOString(), source: 'listing' },
    { id: 'p24', crop: 'beans',      cropNormalized: 'beans',       region: 'Littoral',  priceXaf: 380,  unit: 'kg',     recordedAt: new Date(now.getTime() - 2 * 86400000).toISOString(), source: 'listing' },
    { id: 'p25', crop: 'beans',      cropNormalized: 'beans',       region: 'Northwest', priceXaf: 320,  unit: 'kg',     recordedAt: now.toISOString(),                                     source: 'listing' },
  ];
