...
export class TranslationService {
  private translations = {
    english: {
      ...
      addImageTip:
        'Optional: 📷 Send an image of your product after setting the price!',
      ...
      foundListings: (count: number, product: string) =>
        `🔍 Found ${count} farmer(s) with ${product}`,
      ...
      onlyFarmers: (role: string) =>
        `❌ Only farmers can sell. You are registered as ${role}.`,
      onlyBuyers: (role: string) =>
        `❌ Only buyers can buy. You are registered as ${role}.`,
    ...
    french: {
      ...
      helpFilterPrice:
        'ACHETER maize 20 sacs #10000-20000 (fourchette de prix)',
      helpFilterBoth:
        'ACHETER maize 20 sacs @yaounde #15000-25000 (ville + prix)',
      tips: '💡 Conseils :',
      tipCity:
        '- Utilisez @ avant le nom de la ville pour filtrer par localisation',
      tipPrice:
        '- Utilisez #min-max pour la fourchette de prix (ex: #10000-20000)',
      tipImage:
        '- Ajoutez une image lors de la vente pour attirer les acheteurs !',
      ...
      addImageTip:
        'Optionnel : 📷 Envoyez une image de votre produit après avoir défini le prix !',
      enterCustomPrice:
        '💰 Veuillez entrer votre prix personnalisé.\n\nExemple: 20000',
      ...
      foundListings: (count: number, product: string) =>
        `🔍 Trouvé ${count} agriculteur(s) avec ${product}`,
      replyToSelect:
        'Répondez avec le numéro pour sélectionner un agriculteur.',
      ...
      somethingWrong:
        "❌ Quelque chose s'est mal passé. Recommencez avec une nouvelle commande.",
      notRegistered:
        "❌ Vous devez d'abord vous enregistrer.\n\nRépondez Salut pour commencer.",
      onlyFarmers: (role: string) =>
        `❌ Seuls les agriculteurs peuvent vendre. Vous êtes enregistré comme ${role}.`,
      onlyBuyers: (role: string) =>
        `❌ Seuls les acheteurs peuvent acheter. Vous êtes enregistré comme ${role}.`,
    ...
    pidgin: {
      ...
      enterProduces:
        '🌱 Wetin you grow? Separate by commas.\n\nExample: maize, cassava, tomatoes',
      enterBusiness: '🏪 Wetin be your business name?',
      enterNeeds:
        '🛒 Wetin you need? Separate by commas.\n\nExample: maize, tomatoes, plantain',
      registeredFarmer: (name: string) =>
        `✅ You don register as Farmer!\n\nWelcome ${name} 👨‍🌾\n\nTo list produce, type:\nSELL maize 10 bags\n\nType HELP for options.`,
      registeredBuyer: (name: string) =>
        `✅ You don register as Buyer!\n\nWelcome ${name} 🏪\n\nTo find produce, type:\nBUY maize 20 bags\n\nType HELP for options.`,
      selectLanguage:
      ...
      replyOptions: 'Reply 1 or 2',
      addImageTip:
        'Optional: 📷 Send picture of your product after setting price!',
      ...
      onlyFarmers: (role: string) =>
        `❌ Only farmers fit sell. You don register as ${role}.`,
      onlyBuyers: (role: string) =>
        `❌ Only buyers fit buy. You don register as ${role}.`,
